export type Props = {
  ...
  export default class Button implements IScript<Props> {
    openClip = new AudioClip('Sounds/Chest/open.mp3')
    closeClip = new AudioClip('Sounds/Chest/close.mp3')
    ...
    spawn(host: Entity, props: Props, channel: IChannel) {
      ...
      door.addComponent(new GLTFShape('Models/Chest/Chest_Pirates.glb'))
